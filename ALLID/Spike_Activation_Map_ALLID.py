...
def main():
    ...
    image = image.cuda()
     # Register the hook to your last convolutional feature layer
    ...
    print("raw spike shape:", spikes.shape)
    # Sum over time
    print(model.fc2.weight[prediction].shape)
    spikes_sum = spikes.sum(dim=0)**2 # → [B, C, H, W]
    #sum over channels
